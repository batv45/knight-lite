extends CanvasLayer
## Sol alt köşede sanal joystick. Sürüklenen mesafe/yön -1..1 aralığına
## normalize edilip InputBridge'e yazılır. PC'de mouse ile de çalışır çünkü
## project.godot'ta "emulate_touch_from_mouse" açık.
